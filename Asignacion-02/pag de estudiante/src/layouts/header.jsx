...
const Header = ({ whatsappUrl }) => {
  return (
    <header className="sticky top-0 z-50 backdrop-blur-md bg-slate-900/80 border-b border-blue-900/50 px-6 py-4 transition-all duration-300">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        {/* Navegación y Botón de Contacto */}
        <nav className="flex items-center gap-4">
          <a 
            href="#proyectos" 
            className="hidden sm:inline-block text-slate-300 hover:text-blue-400 font-medium text-sm transition-colors duration-200"
          >
            Proyectos
          </a>
          <a 
